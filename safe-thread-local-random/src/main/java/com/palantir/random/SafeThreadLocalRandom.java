...
/**
 * An implementation of {@link Random} that delegates all methods to {@link ThreadLocalRandom#current()}.
 * This class can be used as a drop in replacement for <code>new Random()</code>.
